...
9. Utiliza únicamente las funciones declaradas ('ranking_peajes', 'comparar_departamentos') con sus nombres exactos, sin prefijos, sufijos ni etiquetas de canal.
"""
